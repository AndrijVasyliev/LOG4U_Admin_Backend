...
import { CreateCoordinatorDto, CoordinatorQuery, CoordinatorResultDto, PaginatedCoordinatorResultDto, UpdateCoordinatorDto } from './coordinator.dto';
...
export class CoordinatorService {
    ...
    async getCoordinators(query: CoordinatorQuery): Promise<PaginatedCoordinatorResultDto> {
    ...
    async createCoordinator(
        ...
        this.log.debug(`Creating new Coordinator: ${JSON.stringify(createCoordinatorDto)}`);
    ...
    async updateCoordinator(
        ...
        const coordinator = await this.findCoordinatorById(id);
        this.log.debug(`Setting new values: ${JSON.stringify(updateCoordinatorDto)}`);
