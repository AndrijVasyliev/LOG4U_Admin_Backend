...
import { CreateDriverValidation, UpdateDriverValidation, driverQueryParamsSchema } from './driver.validation';
...
export class DriverController {
    ...
    @Get()
    async getDrivers(
        @Query(new QueryParamsPipe<DriverQuerySearch>(driverQueryParamsSchema)) driverQuery: DriverQuery,
    ...
    @Post()
    async createDriver(
        @Body(new BodyValidationPipe(CreateDriverValidation)) createDriverBodyDto: CreateDriverDto,
    ): Promise<DriverResultDto> {
    ...
    async updateDriver(
        @Param('driverId', MongoObjectIdPipe) driverId: string,
        @Body(new BodyValidationPipe(UpdateDriverValidation)) updateDriverBodyDto: UpdateDriverDto,
    ): Promise<DriverResultDto> {
