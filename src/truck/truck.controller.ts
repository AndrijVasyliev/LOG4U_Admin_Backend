...
import { CreateTruckValidation, UpdateTruckValidation, truckQueryParamsSchema } from './truck.validation';
...
export class TruckController {
    ...
    @Get()
    async getTrucks(
        @Query(new QueryParamsPipe<TruckQuerySearch>(truckQueryParamsSchema)) truckQuery: TruckQuery,
    ...
    @Post()
    async createTruck(
        @Body(new BodyValidationPipe(CreateTruckValidation)) createTruckBodyDto: CreateTruckDto,
    ): Promise<TruckResultDto> {
    ...
    async updateTruck(
        @Param('truckId', MongoObjectIdPipe) truckId: string,
        @Body(new BodyValidationPipe(UpdateTruckValidation)) updateTruckBodyDto: UpdateTruckDto,
    ): Promise<TruckResultDto> {
